function generateEllipticParaboloid(x, y, z, radius, segments) {
    var vertices = [];
    var colors = [];
...
function main() {
    ...
    var tubeData = generateEllipticParaboloid(0,0, 0.5, 0.6, 100); // Example sphere: x=0, y=0, z=0.5, radius=0.6, segments=100
