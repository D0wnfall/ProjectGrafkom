function generateTabung(x, y, z, radius, height, segments) {
    var vertices = [];
    var colors = [];
...
function main() {
    ...
    var tubeData = generateTabung(0, 0, 0, 0.5, 1.0, 50); // Example tabung: x=0, y=0, z=0, radius=0.5, height=1.0, segments=50
