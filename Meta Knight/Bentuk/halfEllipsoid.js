function generateSphereWithCenter(x, y, z, radius, segments) {
    var vertices = [];
    var colors = [];
  ...
  var sphereData = generateSphereWithCenter(0, 0, 0.5, 0.5, 50); // Example sphere: x=0, y=0, z=0.5, radius=0.5, segments=50
...
function main(){
    ...
    GL.useProgram(SHADER_PROGRAM);
        ...
        var tubeData = generateSphereWithCenter(0, 0, 0.5, 0.5, 50); // Example sphere: x=0, y=0, z=0.5, radius=0.5, segments=50
